...
describe('Conditionals', function () {
  ...
  it('should evaluate <if something> as true (conditionals/if.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/if.html', model), '<p>The variable \'something\' is present</p>')
  })

  it('should evaluate <if doesntexist> as false and trigger <else> condition (conditionals/ifElse.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifElse.html', model), '<p>The variable \'doesntexist\' is not present</p>')
  })

  it('should evaluate <if something=\'Some content\'> as true (conditionals/ifValue.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifValue.html', model), '<p>The variable \'something\' is set to \'Some content\'</p>')
  })

  // #44
  it('should evaluate <if emptyArray> as false (conditionals/ifEmptyArray.html)', function () {
  ...
  it('should evaluate <if something=\'no\'> as false and trigger <else> condition (conditionals/ifElseValue.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifElseValue.html', model), '<p>The variable \'something\' is not set to \'no\'</p>')
  })

  it('should evaluate <unless doesntexist> as true (conditionals/unless.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/unless.html', model), '<p>The variable \'doesntexist\' is not present</p>')
  })

  it('should evaluate <unless something> as false and trigger <else> condition (conditionals/unlessElse.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/unlessElse.html', model), '<p>The variable \'something\' is present</p>')
  })

  it('should evaluate nested <unless> tag in the if (conditionals/unlessNestedIf.html)', function () {
  ...
  it('should evaluate nested <unless> tag in the else (conditionals/unlessNestedElse.html)', function () {
  ...
  it('should evaluate <unless something> as false and trigger <else> condition with comment in between (conditionals/unlessWithComment.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/unlessWithComment.html', model), '<p>The variable \'something\' is present</p>')
  })

  it('should evaluate nested <unless> tag in the if with a comment in between (conditionals/unlessNestedIfWithComment.html)', function () {
  ...
  // #51
  it('should evaluate <unless nullVar> as true (conditionals/unlessNull.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/unlessNull.html', model), '<p>The variable \'nullVar\' is falsey</p>')
  })

  it('should evaluate <unless something=\'Some content\'> as false and trigger <else> condition (conditionals/unlessValue.html)', function () {
  ...
  it('should evaluate <unless something=\'no\'> as false and trigger <else> condition (conditionals/unlessElseValue.html)', function () {
  ...
  it('should evaluate <unless something and notDefined or somethingElse> as false (conditionals/unlessAndOr.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/unlessAndOr.html', model), '<p>should render</p>')
  })

  it('should evaluate entire conditional and correctly show HTML comments (conditionals/commentConditional.html)', function () {
  ...
  it('should evaluate <if something=\'no\'> as false and <elseif somethingElse> as true (conditionals/ifElseIf.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifElseIf.html', model), '<p>The variable \'somethingElse\' is present</p>')
  })

  it('should evaluate <unless something> as false and <elseunless doesntexist> as true (conditionals/unlessElseUnless.html)', function () {
  ...
  it('should eval <if something=\'no\'> as false and <elseunless something=\'maybe\'> as true (conditionals/ifElseUnless.html)', function () {
  ...
  it('should eval <unless something> as false and <elseif somethingElse> as true (conditionals/unlessElseIf.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/unlessElseIf.html', model), '<p>The variable \'somethingElse\' is present</p>')
  })

  it('should evaluate <if something and notDefined> as false (conditionals/and.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/and.html', model), ' <p>and: false</p>')
  })

  it('should evaluate `and` correctly when not using explicit values (conditionals/andImplicit.html)', function () {
  ...
  it('should evaluate `and` correctly using explicit values (conditionals/andExplicit.html)', function () {
  ...
  it('should evaluate `and` truth table (conditionals/andTruthTable.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/andTruthTable.html', model), ' <p>and: true true</p>')
  })

  it('should evaluate `or` truth table correctly (conditionals/orTruthTable.html)', function () {
  ...
  // #24
  it('should evaluate <if something=\'Some content\' or something=\'Nope\'> as true (conditionals/orSameVar.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/orSameVar.html', model), ' <p>or: true</p>')
  })

  it('should evaluate <if something xor somethingElse> as false (conditionals/xor.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/xor.html', model), ' <p>xor: false</p>')
  })

  it('should evaluate xor correctly when not using explicit values (conditionals/xorImplicit.html)', function () {
  ...
  it('should evaluate xor correctly using explicit values (conditionals/xorExplicit.html)', function () {
  ...
  it('should evaluate <if something and notDefined or somethingElse> as true (conditionals/andOr.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/andOr.html', model), ' <p>and + or: true</p>')
  })

  it('should evaluate <if not:something> as false and <if not:noExist> as true (conditionals/not.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/not.html', model), ' <p>not: false</p><p>not: true</p>')
  })

  it('should evaluate one line if "if-something" as true (conditionals/oneLine.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLine.html', model), '<p class="something-is-present">One line if.</p>')
  })

  it('should evaluate one line if "if-somethingFalse" as false (conditionals/oneLineIfBooleanValue.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineIfBooleanValue.html', model), '<p></p>')
  })

  it('should evaluate one line ifs in loops examining the object member\'s value correctly (conditionals/oneLineInLoop.html)', function () {
  ...
  it('should evaluate one line if "if-something" as true when attributes are split across multiple lines (conditionals/oneLineNewLine.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineNewLine.html', model), '<p class="something-is-present">One line if.</p>')
  })

  it('should evaluate one line if "if-something" as true in self-closing element (conditionals/oneLineSelfClosing.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineSelfClosing.html', model), '<input class="something-is-present">')
  })

  it('should evaluate one line if "if-something" as true when result includes slash (/) characters (conditionals/oneLineWithSlash.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineWithSlash.html', model), '<a href="/something">One line if.</a>')
  })

  // #36
  it('should evaluate one line if "if-something" as true with no false condition supplied (conditionals/oneLineTrueOnly.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineTrueOnly.html', model), '<p class="something-is-present">One line if.</p>')
  })

  it('should evaluate one line if "if-something" as false even with no false condition supplied (conditionals/oneLineNoFalse.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineNoFalse.html', model), '<h2>{content.subTitle}</h2>')
  })

  it('should evaluate one line if "if-something=\'Some content\'" as true (conditionals/oneLineValue.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineValue.html', model), '<p class="something-is-value">One line if.</p>')
  })

  it('should evaluate one line if "if-something.something={something}" as false and remove attributes (conditionals/oneLineValueVars.html)', function () {
  ...
  it('should evaluate <option> elements with the middle one selected (conditionals/oneLineValueVarsLooped.html)', function () {
  ...
  it('should evaluate <option> elements with the middle one selected (conditionals/conditionalValueVarsLooped.html)', function () {
  ...
  it('should evaluate one line if "if-something=\'Some content\'" as true and still add the id attribute regardless of the if statement outcome (conditionals/oneLineValueWithAdditionalAttributesNotImpactedByIf.html)', function () {
  ...
  // #46
  it('should evaluate one line if "if-something=\'\'" as false (conditionals/oneLineEmpty.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineEmpty.html', model), '<p class="something-is-value">One line if.</p>')
  })

  // #48
  it('should reduce multiple one line if statements down to only the first one (conditionals/oneLineMulti.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineMulti.html', model), '<p class="something-is-present">One line if.</p>')
  })

  it('should evaluate one line if "if-something" with a dynamic value (conditionals/oneLineDynamicVariable.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineDynamicVariable.html', model), '<p class="some-class">Some content</p>')
  })

  it('should evaluate <if something> as true and the nested <if not:somethingElse> as false, triggering the nested <else> condition (conditionals/nestedConditional.html)', function () {
  ...
  it('should render nothing if condition isn\'t met (conditionals/ifNotPresent.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifNotPresent.html', model), '<div></div>')
  })

  it('should evaluate one line if as false and apply no class (conditionals/oneLineFalse.html)', function () {
  ...
  it('should evaluate if statement that queries the same variable more than once (conditionals/duplicateVarInline.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/duplicateVarInline.html', model), '<p>True</p>')
  })

  it('should evaluate if statement with multiple instances of the same operator inline (conditionals/duplicateOperatorInline.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/duplicateOperatorInline.html', model), '<p>True</p>')
  })

  it('should evaluate <if noExist> containing regex pattern as false and trigger <else> condition (conditionals/ifElseRegex.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifElseRegex.html', model), '<p>False</p>')
  })

  it('should evaluate if statement where elseif condition is a three character named object (conditionals/ifNestedProperties.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifNestedProperties.html', model), '<p>Should render</p>')
  })

  it('should evaluate one line if "if-something" as true with quote types reversed (conditionals/oneLineReverseQuotes.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineReverseQuotes.html', model), '<p class="something-true">One line if.</p>')
  })

  it('should evaluate one line if "if-something" as true with quote types reversed and a variable result (conditionals/oneLineReverseQuotesVar.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/oneLineReverseQuotesVar.html', model), '<p class="Some content">One line if.</p>')
  })

  it('should ignore \'if-\' when not part of an if statement (conditionals/ifOutsideIf.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifOutsideIf.html', model), '<p> gif-something-jpg-png </p>')
  })

  it('should ignore \'if-\' when not part of an if statement with a variable present (conditionals/varIfOutsideIf.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/varIfOutsideIf.html', model), '<p> gif-Some content-jpg-png </p>')
  })

  it('should ignore \'if-\' when not part of an if statement when combined with a normal if statement (conditionals/nestedIfOutsideIf.html)', function () {
  ...
  it('should ignore \'if-\' when not part of an if statement when combined with a one line if statement (conditionals/oneLineIfOutsideIf.html)', function () {
  ...
  it('should ignore \'if-\' when not part of an if statement when \'if-\' is part of an attribute\'s value (conditionals/oneLineIfInsideAttribute.html)', function () {
  ...
  it('should ignore \'if-\' when not part of an if statement when combined with a one line if statement, reversed (conditionals/oneLineIfOutsideIfReverse.html)', function () {
  ...
  it('should evaluate <if doesntexist> as false and trigger <else> condition with preceding HTML comment (conditionals/ifCommentElse.html)', function () {
  ...
  it('should evaluate <if doesntexist> as false and trigger <else> condition with multiple preceding HTML comments (conditionals/ifMultipleCommentsElse.html)', function () {
  ...
  it('should evaluate <if doesntexist> as false and trigger <else> condition with embedded HTML comments in conditional statements (conditionals/ifCommentsEmbedded.html)', function () {
  ...
  it('should evaluate the <unless> condition as true and not render the other conditions (conditionals/ifWithSiblingIfWithNestedIfElse.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifWithSiblingIfWithNestedIfElse.html', model), '<p>Should render.</p>')
  })

  it('should print the letters behind both <if> statements nested in the <loop> (conditionals/ifLoopDoubleIf.html)', function () {
    assert.equalIgnoreSpaces(teddy.render('conditionals/ifLoopDoubleIf.html', model), '<p>a</p><p>b</p><p>a</p><p>b</p><p>a</p><p>b</p>')
  })

  it('should correctly print the JSON string as unmodified text (conditionals/ifJSONStringPrintJSONString.html)', function () {
