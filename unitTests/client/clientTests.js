...
if (!sameOriginPolicy && !oldIE) {
  ...
  unitTest('nested loops test', function() {
    return idoc.getElementsByClassName('nestedLoops')[0].innerHTML.replace(/ xmlns=\"http:\/\/www.w3.org\/1999\/xhtml\"/g, '') == " <p>1</p> <ul> <li>0: one</li> <li>1: two</li> <li>2: three</li> </ul> <p>2</p> <ul> <li>0: four</li> <li>1: five</li> <li>2: six</li> </ul> <p>3</p> <ul> <li>0: seven</li> <li>1: eight</li> <li>2: nine</li> </ul> " ? true : false;
  });
